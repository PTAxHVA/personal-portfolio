...
const Projects = () => {
    return (
        <section id="projects" className="py-32 realtive overflow-hidden px-6">
            {/* Background glow */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="mx-auto text-center max-w-3xl mb-16">
                    <span className="text-secondary-foreground font-medium tracking-wider text-sm uppercase animate-fade-in">
                        Featured Work
                    </span>
