                ...
                <div className="relative">
                    ...
                    <div className="space-y-12">
                        {experiences.map((exp, idx) => (
                            ...
                            >
                                {/* Timeline dot */}
                                <div className="absolute left-0 md:left-1/2 top-0 w-3 h-3 bg-primary rounded-full -translate-x-1.25 md:-translate-x-1/3 ring-4 ring-background z-10">
                                    {exp.current && (
                                ...
                                {/* Content */}
                                <div
                                    className={`pl-8 md:pl-0 ${idx % 2 === 0 ? "md:pr-16 md:text-right md:col-start-1" : "md:col-start-2 md:pl-16"}`}
                                >
                                    <div
