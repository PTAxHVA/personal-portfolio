...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "hoangtuananh26072007@gmail.com",
        href: "mailto:hoangtuananh26072007@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "0845 828 204",
        href: "tel:0845 828 204",
    },
    {
        icon: MapPin,
        label: "Location",
        ...
        <section id="contact" className="relative py-32 overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative overflow-hidden">
                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                    <div className="glass p-8 roundex-3xl border border-primary/30 animate-fade-in animation-delay-300">
                        <form
                            className="space-y-6"
                            action=""
